...
describe("Ether balance Test for accounts", function() {
    ...
    it("Bid Ether Balance", async() => {
        ...
        expect(BigInt(finalOwnerBalance)).to.equal(BigInt(initialBalance) - BigInt(OwnergasUsed) - BigInt(acptGasUsed) + 24n);
    ...
    it("Rent Ether Balance", async() => {
        ...
        expect(BigInt(finalOwnerBalance)).to.equal(BigInt(initialBalance) - BigInt(OwnergasUsed) + 9n);
        expect(BigInt(finalRenterBalance)).to.equal(BigInt(renterInitialBalance) - BigInt(rentGasUsed) - 10n);
