...
function Sidebar(props) {
  ...
  return (
    <Grid item xs={12} md={4}>
      ...
      <Typography fontSize={12} fontStyle="italic" color="blue">Calculated as the average rarity scores of attributes of all NFTs currently owned or rented</Typography>
      <p></p>
      <Card>
