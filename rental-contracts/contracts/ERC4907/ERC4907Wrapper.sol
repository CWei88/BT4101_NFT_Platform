...
contract ERC4907Wrapper is ERC4907, IERC721Receiver, ReentrancyGuard {
    ...
    function getTokenID(uint256 wrapperID) public view virtual returns (uint256) {
        OriginalToken storage token = wrappedTokens[wrapperID];
    ...
    function wrapToken(address _nftAddress, uint256 tokenId) public virtual wrappingResumed nonReentrant returns(uint){
